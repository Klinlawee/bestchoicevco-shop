            ...
            <div className="hidden md:flex items-center space-x-3 lg:space-x-5">
              ...
              {user ? (
                  ...
                  {userMenuOpen && (
                    <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-xl py-2 border z-50">
                      ...
                      <button 
                        ...
                        className="w-full flex items-center space-x-3 px-4 py-2 text-sm text-red-600 hover:bg-red-50 font-medium"
                      >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Link 
                    href="/signup" 
                    className="hidden lg:block bg-[#2c6e49] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-green-700 transition"
                  >
                    Sign Up
                  </Link>
                </div>
